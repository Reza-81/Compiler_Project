...
{
      12,     0,    -1,    13,     8,    -1,    13,     4,    14,    -1,
      13,     5,    14,    -1,    14,    -1,    14,     6,    15,    -1,
      14,     7,    15,    -1,    15,    -1,     3,    -1,     9,    13,
      10,    -1
};
...
{
  "$end", "error", "$undefined", "digit", "ADD", "SUB", "MUL", "DIV",
  "EQ", "PAR_1", "PAR_2", "$accept", "s", "expr", "term", "factor", 0
};
#endif
...
/* Line 1455 of yacc.c  */
#line 49 "bison_file.y"
    {add((yyvsp[(1) - (3)].num)[0], (yyvsp[(3) - (3)].num)[0], (yyval.num)[0]); print_OP((yyvsp[(1) - (3)].num), (yyvsp[(3) - (3)].num), (yyval.num), '+');;}
    break;
...
#line 50 "bison_file.y"
    {sub((yyvsp[(1) - (3)].num)[0], (yyvsp[(3) - (3)].num)[0], (yyval.num)[0]); print_OP((yyvsp[(1) - (3)].num), (yyvsp[(3) - (3)].num), (yyval.num), '-');;}
    break;
...
#line 51 "bison_file.y"
    {strcpy((yyval.num)[0], (yyvsp[(1) - (1)].num)[0]); strcpy((yyval.num)[1], (yyvsp[(1) - (1)].num)[1]);;}
    break;
...
#line 54 "bison_file.y"
    {multiply((yyvsp[(1) - (3)].num)[0], (yyvsp[(3) - (3)].num)[0], (yyval.num)[0]); print_OP((yyvsp[(1) - (3)].num), (yyvsp[(3) - (3)].num), (yyval.num), '*');;}
    break;
...
#line 55 "bison_file.y"
    {division((yyvsp[(1) - (3)].num)[0], (yyvsp[(3) - (3)].num)[0], (yyval.num)[0]); print_OP((yyvsp[(1) - (3)].num), (yyvsp[(3) - (3)].num), (yyval.num), '/');;}
    break;
...
/* Line 1455 of yacc.c  */
#line 60 "bison_file.y"
    {strcpy((yyval.num)[0], (yyvsp[(2) - (3)].num)[0]); strcpy((yyval.num)[1], (yyvsp[(2) - (3)].num)[1]);;}
    break;



/* Line 1455 of yacc.c  */
#line 1404 "bison_file.tab.c"
      default: break;
    }
